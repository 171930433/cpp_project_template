...
void CKFApp::Init(const CSINS& sins0, int grade) {
  ...
  Pk.SetDiag2(fPHI(60, 600), fXXX(1.0), fdPOS(10.0), fDPH3(100), fMG3(5.0), fXXX(1.0), 0.01);
  // Qt.Set2(fDPSH3(0.1),  fUGPSHZ3(1.0),  fOOO,  fOO6,	fOOO, 0.0);
  Qt.Set2(fDPSH3(0.1), fUGPSHZ3(10.0), fOOO, fOO6, fOOO, 0.0);
  Rt.Set2(fXXZ(0.5, 1.0), fdLLH(1.0, 1.0));
  SetRmmbt(0.1, 10, 0.6);
